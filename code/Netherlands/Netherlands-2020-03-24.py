...
day_of_march_ICU  = [16, 17, 18, 19, 20, 21, 22, 23, 24]
current_day = day_of_march[-1]

hosp = [136, 162, 205, 314, 408, 489, 643, 836, 988, 1230, 1495]
ICU = [96, 135, 178, 210, 281, 354, 405, 487, 546]
deceased = [12, 20, 24, 43, 58, 76, 106, 136, 179, 213, 276]
